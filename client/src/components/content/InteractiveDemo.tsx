    ...
    <div className="my-8 border border-doc-border rounded-lg bg-doc-surface overflow-hidden">
      ...
      <div className="px-6 py-4 bg-doc-hover border-b border-doc-border">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-doc-text mb-1">{title}</h3>
            {description && (
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-3">
              <h4 className="text-sm font-medium text-doc-text">Example Code</h4>
              <Button
                variant="outline"
                size="sm"
          ...
          {showOutput && expectedOutput && (
            <div className="mb-6">
              <h4 className="text-sm font-medium text-doc-text mb-3">Expected Output</h4>
