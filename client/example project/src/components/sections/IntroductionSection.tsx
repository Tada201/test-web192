    ...
    <div className="info-section">
      ...
      <section>
        ...
        <div className="flex justify-center">
          <OptimizedImage src="/media/algorithmic.webp" alt="Algorithmic diagram" width={400} height={250} className="my-4" loading="lazy" />
        </div>
        <p>
        ...
        <div className="flex justify-center">
          <OptimizedImage src="/media/class_relationships.webp" alt="Class relationships diagram" width={400} height={250} className="my-4" loading="lazy" />
        </div>
        <p>
        ...
        <div className="flex justify-center">
          <OptimizedImage src="/media/abstraction.webp" alt="Abstraction diagram" width={400} height={250} className="mb-4 rounded shadow" loading="lazy" />
        </div>
        <p>
        ...
        <div className="flex justify-center">
          <OptimizedImage src="/media/classes.webp" alt="Classes diagram" width={400} height={250} className="mb-4 rounded shadow" loading="lazy" />
        </div>
        <br />
        ...
        <div className="flex justify-center">
          <OptimizedImage src="/media/class_relationships.webp" alt="Class relationships diagram" width={400} height={250} className="mb-4 rounded shadow" loading="lazy" />
        </div>
        <br />
        ...
        <p>where visibility is one of:<br />
          ...
          ' ': default(package)<br />
          <div className="flex justify-center">
            <OptimizedImage src="/media/classUML.webp" alt="Class UML diagram" width={400} height={250} className="mb-4 rounded shadow" loading="lazy" />
          </div>
        </p>
        ...
        <p>
          ...
          <div className="flex justify-center">
            <OptimizedImage src="/media/encapsulation.webp" alt="Encapsulation diagram" width={400} height={250} className="mb-4 rounded shadow" loading="lazy" />
          </div>
        </p>
        <p>
        ...
        <p>
          ...
          <br />
          <div className="flex justify-center">
            <OptimizedImage src="/media/differentBehavior.webp" alt="Different behavior diagram" width={400} height={250} className="mb-4 rounded shadow" loading="lazy" />
          </div>
          <div className="flex justify-center">
            <OptimizedImage src="/media/identicalBehavior.webp" alt="Identical behavior diagram" width={400} height={250} className="mb-4 rounded shadow" loading="lazy" />
          </div>
        </p>
        <p>
