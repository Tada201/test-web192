...
// Content structure for search indexing
const searchContent = [
  // Course sections
  {
    id: 'welcome',
    ...
    url: '/section/welcome',
    category: 'course',
    tags: ['welcome', 'introduction', 'overview', 'objectives', 'policy'],
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    category: 'tutorial',
    tags: ['oop', 'concepts', 'abstraction', 'classes', 'uml'],
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    category: 'tutorial',
    tags: ['java', 'jvm', 'data-types', 'variables', 'arrays', 'operators'],
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    category: 'tutorial',
    tags: ['encapsulation', 'classes', 'objects', 'constructors', 'access-modifiers'],
  ...
  },
  {
    ...
    category: 'tutorial',
    tags: ['inheritance', 'extends', 'super', 'polymorphism', 'casting'],
    difficulty: 'Intermediate',
  ...
  },
  {
    ...
    category: 'tutorial',
    tags: ['polymorphism', 'overloading', 'overriding', 'abstract', 'interfaces'],
    difficulty: 'Advanced',
  ...
  },
  {
    ...
    category: 'tutorial',
    tags: ['arrays', 'objects', 'collections', 'file-io', 'streams'],
    difficulty: 'Intermediate',
  ...
  },
  {
    ...
    category: 'tutorial',
    tags: ['collections', 'arraylist', 'treeset', 'hashmap', 'generics'],
    difficulty: 'Intermediate',
  ...
  },
  {
    ...
    category: 'tutorial',
    tags: ['memory', 'heap', 'stack', 'garbage-collection', 'allocation'],
    difficulty: 'Advanced',
  ...
  },
  {
    ...
    category: 'tutorial',
    tags: ['exceptions', 'try-catch', 'error-handling', 'throws'],
    difficulty: 'Intermediate',
  ...
  },
  {
    ...
    url: '/section/io',
    category: 'tutorial',
    tags: ['file-io', 'streams', 'scanner', 'input', 'output'],
    difficulty: 'Intermediate',
  ...
  // Code examples
  {
    ...
    url: '/section/encapsulation',
    category: 'example',
    tags: ['class', 'constructor', 'getter', 'setter', 'example'],
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    url: '/section/inheritance',
    category: 'example',
    tags: ['inheritance', 'extends', 'super', 'override', 'example'],
    difficulty: 'Intermediate',
  ...
  },
  {
    ...
    url: '/section/collection',
    category: 'example',
    tags: ['arraylist', 'collections', 'generics', 'example'],
    difficulty: 'Intermediate',
  ...
  },
  {
    ...
    url: '/section/exception',
    category: 'example',
    tags: ['exception', 'try-catch', 'example'],
    difficulty: 'Intermediate',
  ...
  // Reference materials
  {
    ...
    url: '/section/foundations',
    category: 'reference',
    tags: ['keywords', 'reference', 'java', 'syntax'],
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    url: '/section/introductionCourse',
    category: 'reference',
    tags: ['oop', 'principles', 'concepts', 'reference'],
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    url: '/section/collection',
    category: 'reference',
    tags: ['collections', 'hierarchy', 'interfaces', 'reference'],
    difficulty: 'Intermediate',
  ...
  // Downloads
  {
    ...
    category: 'download',
    tags: ['syllabus', 'pdf', 'download', 'course'],
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    url: '#',
    category: 'download',
    tags: ['cheat-sheet', 'syntax', 'reference', 'java'],
    difficulty: 'Beginner',
  ...
  // Common search terms and their mappings
  {
    ...
    url: '/section/encapsulation',
    category: 'tutorial',
    tags: ['class', 'definition', 'constructor', 'methods'],
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    url: '/section/encapsulation',
    category: 'tutorial',
    tags: ['object', 'new', 'instantiation', 'constructor'],
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    url: '/section/polymorphism',
    category: 'tutorial',
    tags: ['override', 'polymorphism', 'inheritance', 'methods'],
    difficulty: 'Advanced',
...
function buildSearchIndex() {
  const indexData = {
    documents: searchContent,
    metadata: {
      version: '1.0.0',
      buildDate: new Date().toISOString(),
      totalDocuments: searchContent.length,
      categories: [...new Set(searchContent.map(doc => doc.category))],
      difficulties: [...new Set(searchContent.map(doc => doc.difficulty))],
      tags: [...new Set(searchContent.flatMap(doc => doc.tags))]
    }
  };
  ...
  console.log(`📄 ${indexData.totalDocuments} documents indexed`);
  console.log(`📂 Categories: ${indexData.metadata.categories.join(', ')}`);
  console.log(`🏷️  ${indexData.metadata.tags.length} unique tags`);
