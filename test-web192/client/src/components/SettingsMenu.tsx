...
export function SettingsMenu({ isOpen, onClose }: SettingsMenuProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        className="relative bg-doc-surface w-full max-w-4xl rounded-xl shadow-2xl overflow-hidden border border-doc-border"
        style={{
          backgroundColor: "hsl(var(--doc-surface))",
          backdropFilter: "none",
        }}
      >
        {/* Header */}
        ...
        <div className="flex h-96">
          {/* Sidebar */}
          <div
            className="w-64 border-r border-doc-border p-4"
